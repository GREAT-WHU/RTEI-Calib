...
#ifndef RTEI_CALIB_MACROS_HPP
#define RTEI_CALIB_MACROS_HPP
...
#define ASSERT_TIME_STAMP(t)                                                                            \
  if (IS_INVALID_TIME_STAMP(t)) {                                                                       \
    ...
    IC();                                                                                               \
    throw ns_eicalib::Status(ns_eicalib::Status::Flag::FETAL, "the time stamp is invalid, check here: " + str); \
  }
